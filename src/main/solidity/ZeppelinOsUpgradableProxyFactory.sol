/*
 *  EXPERIMENTAL!!!!! Work of the Zeppelin-OS project, reproduced under MIT License
 *
 *  Taken from
 *
 *    https://github.com/zeppelinos/zos/blob/936eec451c2919299171265c7ce48ab0077035b2/packages/lib/contracts/upgradeability/UpgradeabilityProxyFactory.sol
 *
 *  and other items referenced from that file
 *    
 *
 *  I've resolved imports by hand (mostly for the dumb reason that my tools don't yet support single, rather than double, quoting of imported items)
 */
